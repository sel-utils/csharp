...
namespace sul.Protocol.Externalconsole.Status
{
    ...
    public class UpdateStats : sul.Utils.Packet
    {
        ...
        public UpdateStats(uint onlinePlayers, int maxPlayers, uint uptime, uint upload, uint download, NodeStats[] nodes)
        {
        ...
        protected override void EncodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            _buffer.WriteBigEndianInt(maxPlayers);
