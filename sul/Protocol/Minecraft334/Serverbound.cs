...
namespace sul.Protocol.Minecraft334.Serverbound
{
    ...
    public class CraftingGrid : sul.Utils.Packet
    {
        ...
        public Entry[] returnEntry;
        public Entry[] prepareEntry;

        public CraftingGrid() : this(0, 0, new Entry[]{}, new Entry[]{}) {}

        public CraftingGrid(byte window, ushort action, Entry[] returnEntry, Entry[] prepareEntry)
        {
            this.window = window;
            this.action = action;
        ...
        protected override void EncodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            _buffer.WriteBigEndianUshort(returnEntry.Length); foreach (Entry returnEntryChild in returnEntry){ returnEntryChild.EncodeBody(_buffer); }
            _buffer.WriteBigEndianUshort(prepareEntry.Length); foreach (Entry prepareEntryChild in prepareEntry){ prepareEntryChild.EncodeBody(_buffer); }
        }
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //returnEntry.DecodeBody(_buffer);
            //prepareEntry.DecodeBody(_buffer);
        }

        public static CraftingGrid FromBuffer(byte[] buffer)
        {
            var ret = new CraftingGrid();
            ret.Decode(buffer);
            return ret;
        }
    ...
    public class TabComplete : sul.Utils.Packet
    {
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //if(hasPosition==true){ block = _buffer.ReadBigEndianUlong(); }
        }
    ...
    public class ClientSettings : sul.Utils.Packet
    {
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //viewDistance = _buffer.ReadUbyte();
            //chatMode = _buffer.ReadVaruint();
            //chatColors = _buffer.ReadBool();
            //displayedSkinParts = _buffer.ReadUbyte();
            //mainHand = _buffer.ReadUbyte();
        }
    ...
    public class UseEntity : sul.Utils.Packet
    {
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //if(type==2){ targetPosition.Item1 = _buffer.ReadBigEndianFloat(); targetPosition.Item2 = _buffer.ReadBigEndianFloat(); targetPosition.Item3 = _buffer.ReadBigEndianFloat(); }
            //if(type==2){ hand = _buffer.ReadVaruint(); }
        }
    ...
    public class EntityAction : sul.Utils.Packet
    {
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //action = _buffer.ReadVaruint();
            //if(action==5){ jumpBoost = _buffer.ReadVaruint(); }
        }
    ...
    public class CraftingBookData : sul.Utils.Packet
    {
        ...
        public CraftingBookData() : this(0) {}

        public CraftingBookData(uint type)
        {
            this.type = type;
        }
        ...
        {
            var ret = new CraftingBookData();
            ret.Decode(buffer);
            return ret;
        }

        public DisplayedRecipeVariant DisplayedRecipe(uint id)
        {
            var _variant = new DisplayedRecipeVariant(this);
            _variant.id = id;
            return _variant;
        }

        public sealed class DisplayedRecipeVariant : sul.Utils.Variant
        {

            private CraftingBookData _parent;

            public uint id;

            public DisplayedRecipeVariant(CraftingBookData parent) : base(parent)
            {
                this._parent = parent;
                this._parent.type = 1;
            }
        ...
        public CraftingBookStatusVariant CraftingBookStatus(bool bookOpened, bool filtering)
        {
            var _variant = new CraftingBookStatusVariant(this);
            _variant.bookOpened = bookOpened;
            _variant.filtering = filtering;
            return _variant;
        }

        public sealed class CraftingBookStatusVariant : sul.Utils.Variant
        {
            ...
            public CraftingBookStatusVariant(CraftingBookData parent) : base(parent)
            {
                this._parent = parent;
                this._parent.type = 2;
            }
    ...
    public class AdvencementTab : sul.Utils.Packet
    {
        ...
        // action
        public const uint OPEN_TAB = 0;
        public const uint CLOSE_SCREEN = 1;

        public uint action;
        public string tab;

        public AdvencementTab() : this(0, "") {}

        public AdvencementTab(uint action, string tab)
        {
            this.action = action;
            this.tab = tab;
        }
        ...
        {
            _buffer.WriteVaruint(action);
            if(action==0){ _buffer.WriteVaruint(Encoding.UTF8.GetByteCount(tab)); _buffer.WriteString(tab); }
        }

        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            //action = _buffer.ReadVaruint();
            //if(action==0){ tab = _buffer.ReadString(); }
        }

        public static AdvencementTab FromBuffer(byte[] buffer)
        {
            var ret = new AdvencementTab();
            ret.Decode(buffer);
            return ret;
        }
    ...
    public class PlayerBlockPlacement : sul.Utils.Packet
    {
        ...
        public uint face;
        public uint hand;
        public System.Tuple<float, float, float> cursorPosition;

        public PlayerBlockPlacement() : this(0, 0, 0, null) {}

        public PlayerBlockPlacement(ulong position, uint face, uint hand, System.Tuple<float, float, float> cursorPosition)
        {
            this.position = position;
            this.face = face;
            this.hand = hand;
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //hand = _buffer.ReadVaruint();
            //cursorPosition.Item1 = _buffer.ReadBigEndianFloat(); cursorPosition.Item2 = _buffer.ReadBigEndianFloat(); cursorPosition.Item3 = _buffer.ReadBigEndianFloat();
        }
