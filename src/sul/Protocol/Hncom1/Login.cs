...
namespace sul.Protocol.Hncom1.Login
{
    ...
    public class HubInfo : sul.Utils.Packet
    {
        ...
        public HubInfo() : this(0, 0, 0, "", false, new GameInfo[]{}, 0, 0, "", new string[]{}, "") {}

        public HubInfo(ulong time, ulong serverId, ulong reservedUuids, string displayName, bool onlineMode, GameInfo[] gamesInfo, uint online, int max, string language, string[] acceptedLanguages, string additionalJson)
        {
            this.time = time;
