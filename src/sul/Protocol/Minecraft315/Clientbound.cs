...
namespace sul.Minecraft315
{
    ...
    public class SpawnMob : Packet
    {
        ...
        public Tuple<short, short, short> velocity;
        public sul.Metadata.Minecraft315.Metadata metadata;

        public SpawnMob() {}

        public SpawnMob(uint entityId, Guid uuid, uint type, Tuple<double, double, double> position, byte yaw, byte pitch, byte headPitch, Tuple<short, short, short> velocity, sul.Metadata.Minecraft315.Metadata metadata)
        {
            this.entityId = entityId;
            this.uuid = uuid;
            this.type = type;
    ...
    public class SpawnPlayer : Packet
    {
        ...
        public SpawnPlayer(uint entityId, Guid uuid, Tuple<double, double, double> position, byte yaw, byte pitch, sul.Metadata.Minecraft315.Metadata metadata)
        {
            this.entityId = entityId;
            this.uuid = uuid;
            this.position = position;
    ...
    public class EntityMetadata : Packet
    {
        ...
        public EntityMetadata(uint entityId, sul.Metadata.Minecraft315.Metadata metadata)
        {
            this.entityId = entityId;
            this.metadata = metadata;
        }
