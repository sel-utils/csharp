 ...
 */
using Types = sul.Pocket105.Types;

using Utils.Buffer;
using Utils.Packet;

namespace sul.Pocket105
{
    ...
    public class ResourcePacksInfo : Packet
    {
        ...
        public override void EncodeImpl(Buffer _buffer)
        {
            ...
            behaviourPacks.EncodeImpl(_buffer);
            resourcePacks.EncodeImpl(_buffer);
        }
    ...
    public class AddPlayer : Packet
    {
        ...
        public sul.Metadata.Pocket105.Metadata metadata;

        public AddPlayer() {}

        public AddPlayer(Guid uuid, string username, long entityId, long runtimeId, Tuple<float, float, float> position, Tuple<float, float, float> motion, float pitch, float headYaw, float yaw, Types.Slot heldItem, sul.Metadata.Pocket105.Metadata metadata)
        {
            this.uuid = uuid;
    ...
    public class AddEntity : Packet
    {
        ...
        public AddEntity(long entityId, long runtimeId, uint type, Tuple<float, float, float> position, Tuple<float, float, float> motion, float pitch, float yaw, Types.Attribute[] attributes, sul.Metadata.Pocket105.Metadata metadata, Types.Link[] links)
        {
            this.entityId = entityId;
            this.runtimeId = runtimeId;
            this.type = type;
    ...
    public class SetEntityData : Packet
    {
        ...
        public SetEntityData(long entityId, sul.Metadata.Pocket105.Metadata metadata)
        {
            this.entityId = entityId;
            this.metadata = metadata;
        }
    ...
    public class CommandBlockUpdate : Packet
    {
        ...
        public override void EncodeImpl(Buffer _buffer)
        {
            ...
            _buffer.WriteString(command);
            _buffer.WriteString(lastOutput);
            _buffer.WriteString(hover);
