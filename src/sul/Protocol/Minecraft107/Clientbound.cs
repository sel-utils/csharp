...
namespace sul.Protocol.Minecraft107.Clientbound
{
    ...
    public class SpawnMob : sul.Utils.Packet
    {
        ...
        public SpawnMob(uint entityId, System.Guid uuid, byte type, System.Tuple<double, double, double> position, byte yaw, byte pitch, byte headPitch, System.Tuple<short, short, short> velocity, Metadata metadata)
        {
            this.entityId = entityId;
            this.uuid = uuid;
            this.type = type;
    ...
    public class NamedSoundEffect : sul.Utils.Packet
    {
        ...
        public NamedSoundEffect(string name, uint category, System.Tuple<int, int, int> position, float volume, byte pitch)
        {
            this.name = name;
    ...
    public class ChangeGameState : sul.Utils.Packet
    {
        ...
        public const byte PLAY_MOB_APPEARANCE = 10;
    ...
    public class ChunkData : sul.Utils.Packet
    {
        ...
        public ChunkData() : this(null, false, 0, new byte[]{}) {}

        public ChunkData(System.Tuple<int, int> position, bool full, uint sections, byte[] data)
        {
            this.position = position;
            this.full = full;
    ...
    public class Effect : sul.Utils.Packet
    {
        ...
        public const uint DOOR_OPEN_OR_CLOSE = 1003;
        public const uint FIREWORK_SHOT = 1004;
        public const uint PLAY_DISC = 1005;
        public const uint GHAST_WARN = 1007;
        public const uint GHAST_SHOOT = 1008;
        public const uint ZOMBIE_ATTACK_WOOD_DOOR = 1010;
        public const uint ZOMBIE_ATTACK_IRON_DOOR = 1011;
        public const uint ZOMBIE_BREAK_WOOD_DOOR = 1012;
        public const uint WITHER_SPAWN = 1013;
        public const uint WITHER_SHOOT = 1014;
        public const uint BAT_TAKE_OFF = 1015;
        public const uint ZOMBIE_INFECT_VILLAGER = 1016;
        public const uint ZOMBIE_VILLAGER_CONVERT = 1017;
        public const uint ANVIL_BREAK = 1019;
        public const uint ANVIL_USE = 1020;
        public const uint ANVIL_LAND = 1021;
        public const uint SPAWN_10_SMOKE_PARTICLES = 2000;
        public const uint BREAK_BREAK_PARTICLES = 2001;
    ...
    public class JoinGame : sul.Utils.Packet
    {
        ...
        // dimension
        public const sbyte NETHER = -1;
        public const sbyte OVERWORLD = 0;
        public const sbyte END = 1;
        ...
        public JoinGame(uint entityId, byte gamemode, sbyte dimension, byte difficulty, byte maxPlayers, string levelType, bool reducedDebug)
        {
            this.entityId = entityId;
    ...
    public class SoundEffect : sul.Utils.Packet
    {
        ...
        public SoundEffect(uint soundId, uint category, System.Tuple<int, int, int> position, float volume, byte pitch)
        {
    ...
    public class EntityEffect : sul.Utils.Packet
    {
        ...
        public EntityEffect() : this(0, 0, 0, 0, false) {}
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //hideParticles = _buffer.ReadBool();
        }
