...
namespace sul.Protocol.Minecraft333.Types
{
    ...
    public class Icon : sul.Utils.Stream
    {
        ...
        public const byte SMALL_WHITE_CIRCLE = 7;
        public const byte MANSION = 8;
        public const byte TEMPLE = 9;
    ...
    public class Entry : sul.Utils.Stream
    {
        ...
        public Entry() : this(new Slot(), 0, 0) {}

        public Entry(Slot item, byte craftingSlot, byte playerSlot)
        {
            this.item = item;
        ...
        protected override void DecodeImpl(sul.Utils.Buffer _buffer)
        {
            ...
            //craftingSlot = _buffer.ReadUbyte();
            //playerSlot = _buffer.ReadUbyte();
        }
