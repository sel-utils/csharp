 ...
 */
using Types = sul.Pocket100.Types;

using Utils.Buffer;
using Utils.Packet;

namespace sul.Pocket100
{
    ...
    public class AddPlayer : Packet
    {
        ...
        public sul.Metadata.Pocket100.Metadata metadata;

        public AddPlayer() {}

        public AddPlayer(Guid uuid, string username, long entityId, long runtimeId, Tuple<float, float, float> position, Tuple<float, float, float> motion, float pitch, float headYaw, float yaw, Types.Slot heldItem, sul.Metadata.Pocket100.Metadata metadata)
        {
            this.uuid = uuid;
    ...
    public class AddEntity : Packet
    {
        ...
        public AddEntity(long entityId, long runtimeId, uint type, Tuple<float, float, float> position, Tuple<float, float, float> motion, float pitch, float yaw, Types.Attribute[] attributes, sul.Metadata.Pocket100.Metadata metadata, Types.Link[] links)
        {
            this.entityId = entityId;
            this.runtimeId = runtimeId;
            this.type = type;
    ...
    public class SetEntityData : Packet
    {
        ...
        public SetEntityData(long entityId, sul.Metadata.Pocket100.Metadata metadata)
        {
            this.entityId = entityId;
            this.metadata = metadata;
        }
