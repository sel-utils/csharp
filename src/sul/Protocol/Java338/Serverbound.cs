...
using sul.Utils;
using sul.Protocol.Java338.Types;

namespace sul.Protocol.Java338.Serverbound
{
    ...
    public class CraftRecipeRequest : sul.Utils.Packet
    {
        ...
        public CraftRecipeRequest() : this(0, 0, false) {}

        public CraftRecipeRequest(byte window, uint recipe, bool makeAll)
        {
            this.window = window;
            this.recipe = recipe;
        ...
        {
            var ret = new CraftRecipeRequest();
            ret.Decode(buffer);
            return ret;
        }
