...
namespace sul.Protocol.Java338.Clientbound
{
    ...
    public class CraftRecipeResponse : sul.Utils.Packet
    {
        ...
        public CraftRecipeResponse() : this(0, 0) {}

        public CraftRecipeResponse(byte window, uint recipe)
        {
            this.window = window;
            this.recipe = recipe;
        }
        ...
        {
            var ret = new CraftRecipeResponse();
            ret.Decode(buffer);
            return ret;
        }
    ...
    public class AdvancementProgress : sul.Utils.Packet
    {
        ...
        {
            //_buffer.ReadBool()
            //if(notEmpty==true){ _buffer.ReadString() }
        }
